...
> Source: [designmd.ai/chef/rawblock](https://designmd.ai/chef/rawblock) · Author: [Chef @chef](https://designmd.ai/chef) · License: MIT · Version v1
>
> Downloaded and implemented in OPE as the canonical UI language (`design/rawblock.css`).
